...
{
public:
  explicit Init_SystemStatus_stamp(::status_interfaces::msg::SystemStatus & msg)
  : msg_(msg)
  {}
  ::status_interfaces::msg::SystemStatus stamp(::status_interfaces::msg::SystemStatus::_stamp_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemStatus_stamp net_recv(::status_interfaces::msg::SystemStatus::_net_recv_type arg)
  {
    msg_.net_recv = std::move(arg);
    return Init_SystemStatus_stamp(msg_);
  }
...
{
  return status_interfaces::msg::builder::Init_SystemStatus_host_name();
}
